...
import { BiasValue } from "@/components/sentiment/BiasValue";
import { NetPositionChart } from "@/components/sentiment/NetPositionChart";
import { SentimentBar } from "@/components/sentiment/SentimentBar";
import { Sparkline } from "@/components/sentiment/Sparkline";
import { SourceNote } from "@/components/sentiment/SourceNote";
import { StatusBadge } from "@/components/sentiment/StatusBadge";
...
export default async function MarketDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 pb-16 pt-6">
      ...
      <Link href="/sentiment" className="text-xs text-muted hover:text-white">
        ← MARKET SENTIMENT
      </Link>
