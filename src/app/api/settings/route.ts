...
const schema = z.object({
  ...
  reminderBackoffEnabled: z.boolean().optional(),
  maxReminderIntervalMinutes: z.number().int().min(0).max(10080).optional(),
  lineMonthlyFreeQuota: z.number().int().min(0).max(1000000).optional(),
